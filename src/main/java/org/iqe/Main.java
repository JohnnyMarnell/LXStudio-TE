...
public class Main extends PApplet implements LXPlugin {
    public static LXPlugin delegate;

    @Override
    public void initialize(LX lx) {
        delegate.initialize(lx);
    }

    public static void main(String[] args) {
        System.out.println("Wrapper main");
        PApplet.main(LXStudioApp.class, args);
    }

    public static class LXStudioApp extends PApplet implements LXPlugin {
